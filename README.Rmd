...
2. Implement algorithms for a specific movement path and array combination via `sim_workhorse` or for all movement paths and array designs via `sim_implement`*. Note that for the former, the movement path and array ID need to be specified at the top of the script.
